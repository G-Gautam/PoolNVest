...
exports.ABI = [
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: '_attestationExpirySeconds', type: 'uint256' },
    ...
    },
    {
        ...
        inputs: [
            { name: 'identifier', type: 'bytes32' },
            { name: 'encryptedPhone', type: 'bytes' },
            { name: 'issuer', type: 'address' },
            { name: 'sendSms', type: 'bool' },
        ],
        name: 'reveal',
        outputs: [],
        payable: false,
    ...
    {
        constant: false,
        inputs: [{ name: 'identifier', type: 'bytes32' }, { name: 'index', type: 'uint256' }],
        name: 'revoke',
        outputs: [],
        payable: false,
        stateMutability: 'nonpayable',
    ...
    {
        constant: true,
        inputs: [{ name: 'identifier', type: 'bytes32' }, { name: 'account', type: 'address' }],
    ...
    },
    {
        ...
        outputs: [{ name: '', type: 'uint64' }, { name: '', type: 'uint64' }],
        payable: false,
        stateMutability: 'view',
        type: 'function',
    },
    ...
    },
    {
        ...
        outputs: [{ name: '', type: 'uint8' }, { name: '', type: 'uint128' }],
        payable: false,
        stateMutability: 'view',
        type: 'function',
    },
    ...
    {
        constant: false,
        inputs: [{ name: 'token', type: 'address' }, { name: 'fee', type: 'uint256' }],
    ...
    {
        constant: false,
        inputs: [{ name: '_attestationExpirySeconds', type: 'uint256' }],
