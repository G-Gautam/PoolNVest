...
exports.ABI = [
    ...
    },
    {
        ...
        name: 'voters',
        outputs: [
            { name: 'upvotedProposal', type: 'uint256' },
            { name: 'mostRecentReferendumProposal', type: 'uint256' },
        ],
        payable: false,
        stateMutability: 'view',
        type: 'function',
    ...
    {
        constant: false,
        inputs: [{ name: 'lesser', type: 'uint256' }, { name: 'greater', type: 'uint256' }],
        name: 'revokeUpvote',
        outputs: [{ name: '', type: 'bool' }],
        payable: false,
        stateMutability: 'nonpayable',
    ...
    {
        constant: false,
        inputs: [{ name: 'proposalId', type: 'uint256' }, { name: 'index', type: 'uint256' }],
        name: 'approve',
        outputs: [{ name: '', type: 'bool' }],
        payable: false,
        stateMutability: 'nonpayable',
    ...
    {
        constant: true,
        inputs: [{ name: 'destination', type: 'address' }, { name: 'functionId', type: 'bytes4' }],
    ...
    {
        constant: true,
        inputs: [{ name: 'dequeueTime', type: 'uint256' }],
    ...
    {
        constant: true,
        inputs: [{ name: 'dequeueTime', type: 'uint256' }, { name: 'stage', type: 'uint8' }],
        name: 'stageStartTime',
        outputs: [{ name: '', type: 'uint256' }],
        payable: false,
        stateMutability: 'view',
