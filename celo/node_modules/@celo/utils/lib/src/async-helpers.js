...
var TAG = 'utils/src/async-helpers';
    ...
    return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    error_1 = _a.sent();
                    return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, delay); })]; // sleeps `delay` milliseconds
                case 5:
                    _a.sent(); // sleeps `delay` milliseconds
                    saveError = error_1;
