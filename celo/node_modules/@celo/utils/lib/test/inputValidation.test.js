...
var inputValidation_1 = require("../src/inputValidation");
describe('inputValidation', function () {
    ...
    validateFunction('allows comma decimals', numbers.map(function (val) { return val.replace('.', ','); }), inputValidation_1.ValidatorKind.Decimal, '1,23', { lng: 'es-AR' });
